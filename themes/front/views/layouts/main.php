<!DOCTYPE html>
 <html class="no-js"> 
    <head>
      ...
      <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->theme->baseUrl.'/assets/'; ?>css/prettyPhoto.css"/>
      <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->theme->baseUrl.'/assets/'; ?>css/responsiveslides.css"/>
      ...
      <script type="text/javascript" src="<?php echo Yii::app()->theme->baseUrl.'/assets/'; ?>js/hover-image.js"></script>    
      <script type="text/javascript" src="<?php echo Yii::app()->theme->baseUrl.'/assets/'; ?>js/jquery.bxSlider.js"></script>
      <script type="text/javascript" src="<?php echo Yii::app()->theme->baseUrl.'/assets/'; ?>js/custom.js"></script>
      <script type="text/javascript" src="<?php echo Yii::app()->theme->baseUrl.'/assets/'; ?>js/responsiveslides.min.js"></script>
